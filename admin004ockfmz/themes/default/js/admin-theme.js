...
$(document).ready(function() {
    var urlAdminMothers = $("#subtab-AdminGroups").find("a").attr("href");
    $("#subtab-AdminGroups").find("a").attr("href", urlAdminMothers+"&viewgroup=true&id_group=10");
    $("#subtab-AdminGroups").show();
