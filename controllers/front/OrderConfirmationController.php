...
class OrderConfirmationControllerCore extends FrontController
{
    ...
    public function initContent()
    {
        ...
        $ordersReference = Order::getOrdersByReference($order->reference);
        foreach ($ordersReference as $key => $orderReference) {
            $orderData = new Order($orderReference["id_order"]);
            $presentedOrders[] = $this->order_presenter->present($orderData);
        }
