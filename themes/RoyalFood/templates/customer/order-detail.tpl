...
{block name='page_content'}
            ...
            {if $order.details.invoice_url}
              <li>
                <a href="{$order.details.invoice_url}">
                  {l s='Descarge su pedido como archivo PDF.' d='Shop.Theme.Customeraccount'}
                </a>
              </li>
            {/if}
  ...
  {block name='order_carriers'}
    {if $order.shipping}
      <div class="box">
        <table class="table table-striped table-bordered hidden-sm-down" id="shipping-table-order">
          <thead class="thead-default">
            <tr>
              <th>{l s='Date' d='Shop.Theme.Global'}</th>
