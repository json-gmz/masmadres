...
<table id="summary-tab" width="100%">
	<tr>
		<!--<th class="header small" valign="middle">{l s='Order Number' d='Shop.Pdf' pdf='true'}</th>-->
		<!-- th class="header small" valign="middle">{l s='Date Reference' d='Shop.Pdf' pdf='true'}</th-->
