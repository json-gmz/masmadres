...
class CustomerType extends AbstractType
{
    ...
    public function __construct(
        ...
        $urlGetServices = $_SERVER["SERVER_NAME"]."/ajax/ApiGetServices.php";

        $cliente = curl_init();
        curl_setopt($cliente, CURLOPT_URL, $urlGetServices);
        ...
        $respuesta = explode("\n\r\n", $respuesta);
        $body = $respuesta[(count($respuesta)-1)];
        $serviceChoices = json_decode($body, true);
