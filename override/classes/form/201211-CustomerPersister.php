...
class CustomerPersisterCore
{
    ...
    public function save(Customer $customer, $clearTextPassword, $newPassword = '', $service, $product_service, $passwordRequired = true, $fileone,  $filetwo, $filetree, $filefour)
    {
        if ($customer->id) {
            return $this->update($customer, $clearTextPassword, $newPassword, $service, $product_service, $passwordRequired);
        } else {
            return $this->create($customer, $clearTextPassword, $service, $product_service, $fileone, $filetwo, $filetree, $filefour);
        }
    }

    private function update(Customer $customer, $clearTextPassword, $newPassword, $service, $product_service, $passwordRequired = true)
    {
    ...
    private function create(Customer $customer, $clearTextPassword, $service, $product_service, $fileone, $filetwo, $filetree, $filefour)
    {
